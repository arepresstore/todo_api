...
SECRET_KEY = "django-insecure-&j7sx2a&1-@mie-wgmua6@4gg)w13@x1ru4gp#jf2v_jge#zzw"
...
INSTALLED_APPS = [
    ...
    'rest_framework.authtoken',   # Токены для аутентификации API
    'todos',
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'todo_db',
        'USER': 'postgres',  # Или другое имя пользователя, если вы создали его
        'PASSWORD': 'YTlt3663',  # Пароль, который вы задали при установке
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
...
TIME_ZONE = 'Europe/Moscow'     # Часовой пояс (можно поменять на свой)
USE_I18N = True                # Включить интернационализацию
USE_L10N = True                # Локализация (форматы дат, чисел)
USE_TZ = True
